	...
	<div class="col-xs-12" id="config">
		<div class="input-group search-bar-group">
			...
			<div class="input-group-btn">
				<button type="button" id="bt_resetConfigSearch" class="btn" ><i class="fas fa-times"></i> </button>
			</div>
			<div class="input-group-btn">
		...
		<div class="tab-content sidebar-tab-content">
			<div role="tabpanel" class="tab-pane active" id="generaltab">
				...
				<form class="form-horizontal">
					<div class="config-card">
						...
						<div class="modern-form-group">
							<label>{{Serveur de temps optionnel}}
						...
						<div class="modern-form-group">
							<label>{{Ignorer la vérification de l'heure}}
			...
			<div role="tabpanel" class="tab-pane" id="interfacetab">
				...
				<form class="form-horizontal">
					<div class="config-card">
						...
						<div class="modern-form-group">
							<label>{{Désactiver les ombres}}</label>
							<div class="form-controls">
				...
				<form class="form-horizontal">
					<div class="config-card">
						...
						<div class="modern-form-group">
							<label>{{Réorganisation automatique}}</label>
							<div class="form-controls">
								<div class="input-group">
				...
				<form class="form-horizontal col-xs-12">
					<div class="config-card">
						...
						foreach ($repos as $key => $value) {
							...
							$div = '<div class="modern-form-group">';
							$div .= '<label>{{DNS}} ' . $value['name'] . '</label>';
				...
				<form class="form-horizontal">
					<div class="config-card">
						...
						<div class="modern-form-group">
							...
							<label>{{Evènements actuels}} : </label>
						...
						<div class="modern-form-group">
							<label>{{Supprimer tous les évènements de la Timeline qui sont dans le futur}}</label>
							<div class="col-lg-3 col-md-4 col-sm-5 col-xs-4">
						...
						<div class="modern-form-group">
							<label>{{Supprimer tous les évènements de la Timeline}}</label>
							<div class="col-lg-3 col-md-4 col-sm-5 col-xs-4">
						...
						<div class="form-group" data-channel="">
							<label>{{Action sur message}}</label>
							<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
						...
						foreach ($JEEDOM_INTERNAL_CONFIG['messageChannel'] as $k => $v) {
							...
							echo '<label>' . $v['icon'] . ' {{Action sur message, channel}} ' . $v['name'] . '</label>';
						...
						<form class="form-horizontal">
							<div class="config-card">
								...
								foreach ($JEEDOM_INTERNAL_CONFIG['alerts'] as $level => $value) {
									$div .= '<div class="modern-form-group">';
									$div .= '<label>{{Ajouter un message à chaque}} ' . $value['name'] . '</label>';
									$div .= '<div class="col-sm-1">';
									$div .= '<input type="checkbox" class="configKey" data-l1key="alert::addMessageOn' . ucfirst($level) . '"/>';
									$div .= '</div>';
									$div .= '</div>';
									$div .= '<div class="modern-form-group">';
									$div .= '<label>{{Commande sur}} ' . $value['name'] . '</label>';
					...
					<div role="tabpanel" class="tab-pane" id="log_log">
						<form class="form-horizontal">
							<div class="config-card">
								<br>
								<div class="modern-form-group">
									<label>{{Nombre maximal de lignes dans un fichier de log}}</label>
									<div class="col-lg-3 col-md-4 col-sm-5 col-xs-6">
										<input type="text" class="configKey form-control" data-l1key="maxLineLog">
									</div>
								</div>
								<div class="modern-form-group">
									<label>{{Taille maximale pour fichier de log (en Mo)}}</label>
									<div class="col-lg-3 col-md-4 col-sm-5 col-xs-6">
										<input type="text" class="configKey form-control" data-l1key="maxSizeLog" />
									</div>
								</div>
								<div class="modern-form-group">
									<label>{{Niveau de log par défaut}}</label>
									<div class="col-lg-3 col-md-4 col-sm-5 col-xs-6">
								...
								if (init('rescue', 0) == 0) {
									...
									foreach ((plugin::listPlugin(true)) as $plugin) {
										$div .= '<form class="form-horizontal">';
										$div .= '<div class="modern-form-group">';
										$div .= '<label>' . $plugin->getName() . '</label>';
										$div .= '<div class="col-sm-8">';
			...
			<div role="tabpanel" class="tab-pane" id="eqlogictab">
				...
				<form class="form-horizontal">
					<div class="config-card">
						...
						<div class="modern-form-group">
							<label>{{Seuil des piles}}<i class="warning jeedom-batterie1" style="font-size:36px;vertical-align: middle;"></i> {{Inférieur à}}
						...
						<div class="modern-form-group">
							<label>{{Seuil des piles}}<i class="danger jeedom-batterie0" style="font-size:36px;vertical-align: middle;"></i> {{Inférieur à}}
								<sup><i class="fas fa-question-circle" tooltip="{{Si le niveau de charge passe en dessous de (%)}}"></i></sup>
								<sub>%</sub>
							</label>
							<div class="col-lg-1 col-sm-1 col-xs-4">
				...
				<form class="form-horizontal">
					<div class="config-card">
						...
						<div class="modern-form-group">
							<label>{{Période de calcul pour min, max, moyenne}}
								<sub>h</sub>
							</label>
							<div class="col-lg-1 col-md-2 col-sm-5 col-xs-6">
								<input type="text" class="configKey form-control" data-l1key="historyCalculPeriod">
							</div>
							<label>{{Période de calcul pour la tendance}}
								<sub>h</sub>
							</label>
							<div class="col-lg-1 col-md-2 col-sm-5 col-xs-6">
						...
						<div class="modern-form-group">
							<label>{{Période d'affichage des graphiques par défaut}}</label>
							<div class="col-lg-2 col-md-2 col-sm-5 col-xs-6">
						...
						<div class="modern-form-group">
							<label>{{Purger l'historique si plus vieux que}}</label>
							<div class="col-lg-2 col-md-2 col-sm-5 col-xs-6">
						...
						<div class="modern-form-group">
							<label>{{Autoriser les dates dans le futur}}
						...
						<div class="modern-form-group">
							<label>{{Supprimer tous les historiques qui sont dans le futur}}</label>
							<div class="col-lg-3 col-md-4 col-sm-5 col-xs-4">
					...
					<div class="config-card">
						...
						foreach ($JEEDOM_INTERNAL_CONFIG['cmd']['type'] as $type => $subtypes) { //info or action
							...
							foreach ($subtypes['subtype'] as $subtype => $value) { //Each subtype per info or action
								$div = '';
								$div .= '<div class="modern-form-group">';
								$div .= '<label>' . $icon . $JEEDOM_INTERNAL_CONFIG['cmd']['type'][$type]['name'] . ' ' . $value['name'] . '</label>';
				...
				<form class="form-horizontal">
					<div class="config-card">
						<div class="modern-form-group">
							...
							<label>{{Port du serveur InfluxDB}}</label>
							<div class="col-lg-1 col-md-2 col-sm-5 col-xs-6">
						...
						<div class="modern-form-group">
							<label>{{Utilisateur de la base}}</label>
							<div class="col-lg-3 col-md-3 col-sm-5 col-xs-6">
			...
			<div role="tabpanel" class="tab-pane" id="repporttab">
				...
				<form class="form-horizontal">
					<div class="config-card">
						<div class="modern-form-group">
							<label>{{Délai d'attente après génération de la page}}
								<sub>ms</sub>
							</label>
						...
						<div class="modern-form-group">
							<label>{{Nettoyer les rapports plus anciens de}}
								<sub>j</sub>
							</label>
							<div class="col-lg-2 col-md-2 col-sm-4 col-xs-6">
			...
			<div role="tabpanel" class="tab-pane" id="interacttab">
				...
				<form class="form-horizontal">
					<div class="config-card">
						...
						<div class="modern-form-group">
							<label>{{Regex générale d'exclusion pour les interactions}}</label>
							<div class="col-lg-8 col-md-8 col-sm-8 col-xs-6">
						...
						<div class="modern-form-group">
							<label>{{Commande de retour par défaut}}</label>
							<div class="col-lg-8 col-md-8 col-sm-8 col-xs-6">
								<div class="input-group">
			...
			<div role="tabpanel" class="tab-pane" id="securitytab">
					...
					<form class="form-horizontal">
						...
						<div class="modern-form-group">
							<label>{{Temps maximum entre les échecs}}
						...
						<?php if (function_exists('ldap_connect')) { ?>
							...
							<div id="div_config_ldap">
								...
								<div class="modern-form-group">
									<label>{{Base DN des utilisateurs}}
								...
								<div class="modern-form-group">
									<label>{{Champs recherche utilisateur}}
								...
								<div class="modern-form-group">
									<label>{{Filtre administrateurs (optionnel)}}
								...
								<div class="modern-form-group">
									<label>{{Filtre utilisateurs (optionnel)}}
								...
								<div class="modern-form-group">
									<label>{{Filtre utilisateurs limités (optionnel)}}
						...
						<div class="modern-form-group">
							<label>{{Autoriser le lancement du démon d'un même plugin à moins de 45s d'intervalle}}
					...
					<div class="col-sm-12">
						<form class="form-horizontal">
							<div class="config-card">
								...
								<div class="modern-form-group">
									<label>{{Vérification automatique des mises à jour}}</label>
									<div class="col-sm-1">
										<input type="checkbox" class="configKey" data-l1key="update::autocheck">
									</div>
								</div>
								<div class="modern-form-group">
									<label>{{[DANGER] Mettre à jour les dépendances PHP (composer) après chaque mise à jour du core}}</label>
									<div class="col-sm-1">
								...
								<div class="tab-content">
									...
									foreach ($repos as $key => $value) {
										...
										if (isset($value['scope']['test']) && $value['scope']['test']) {
											$div .= '<div class="modern-form-group">';
											$div .= '<label>{{Tester/Synchroniser}}</label>';
											$div .= '<div class="col-lg-3 col-md-4 col-xs-5">';
			...
			<div role="tabpanel" class="tab-pane" id="cachetab">
				...
				<form class="form-horizontal">
					<div class="config-card">
						...
						<div class="modern-form-group">
							<label>{{Temps de pause pour le long polling}}
						...
						<hr>
						<div class="modern-form-group">
							<label>{{Vider toutes les données en cache}}
			...
			<div role="tabpanel" class="tab-pane" id="apitab">
				...
				<form class="form-horizontal">
					<div class="config-card">
						...
						<div class="modern-form-group">
							<label>{{Interdire les méthodes api (regexp)}}</label>
							<div class="col-lg-10 col-md-9 col-sm-8 col-xs-12">
								<input type="text" class="configKey form-control" data-l1key="api::forbidden::method">
							</div>
						</div>
						<div class="modern-form-group">
							<label>{{N'autoriser que les méthodes api (regexp)}}</label>
							<div class="col-lg-10 col-md-9 col-sm-8 col-xs-12">
			...
			<div role="tabpanel" class="tab-pane" id="ostab">
				...
				<form class="form-horizontal">
					<div class="config-card">
						...
						<div class="modern-form-group">
							<label><i class="fas fa-terminal"></i> {{Rétablissement des droits des dossiers et fichiers}}
						...
						<div class="modern-form-group">
							<label><i class="fas fa-box-open"></i> {{Vérification des packages système}}
						...
						<div class="modern-form-group">
							<label><i class="fas fa-database"></i> {{Vérification de la base de données}}
						...
						<div class="modern-form-group">
							<label><i class="fas fa-database"></i> {{Nettoyage de la base de données}}<sup><i class="fas fa-question-circle" tooltip="{{Nettoie la base de données (objets, commandes, historiques et autres informations non valides).}}"></i></sup>
							</label>
							<div class="col-lg-3 col-md-4 col-sm-5 col-xs-4">
