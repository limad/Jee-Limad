	...
	<div class="hasfloatingbar col-lg-12 col-md-12 col-sm-12 col-xs-12">
		<div class="floatingbar">
			<div class="input-group">
				<span class="input-group-btn">
					...
					<button type="button" id="bt_resetGlobalLogSearch" class="btn btn-sm"><i class="fas fa-times"></i></button>
					<button type="button" class="btn btn-warning btn-sm" data-state="1" id="bt_globalLogStopStart"><i class="fas fa-pause"></i><span class="hidden-768"> {{Pause}}</span>
					</button><button type="button" class="btn btn-success btn-sm" id="bt_downloadLog"><i class="fas fa-cloud-download-alt"></i><span class="hidden-768"> {{Télécharger}}</span>
					</button><button type="button" class="btn btn-warning btn-sm" id="bt_clearLog"><i class="fas fa-times"></i><span class="hidden-768"> {{Vider}}</span>
					</button><button type="button" class="btn btn-warning btn-sm" id="bt_clearAllLog"><i class="fas fa-times-circle"></i><span class="hidden-768"> {{Vider tout}}</span>
					</button><button type="button" class="btn btn-danger btn-sm" id="bt_removeLog"><i class="far fa-trash-alt"></i><span class="hidden-768"> {{Supprimer}}</span>
					</button><button type="button" class="btn btn-danger btn-sm roundedRight" id="bt_removeAllLog"><i class="fas fa-trash"></i><span class="hidden-768"> {{Supprimer tout}}</span></button>
				</span>
			</div>
		</div>
		<div class="input-group pull-left col-lg-2 col-md-3 col-sm-12 col-xs-12" style="top: 7px;">
			<span class="input-group-btn pull-left">
				...
				<button type="button" id="bt_resetLogFilterSearch" class="btn btn-sm roundedRight"><i class="fas fa-times"></i></button>
			</span>
		</div>
	</div>
	<br /><br />
